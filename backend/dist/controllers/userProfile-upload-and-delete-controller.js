...
const userProfileUploadAndDeleteController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.userId;
        const userProfileImage = req.body;
        const response = yield userModel_js_1.default.findOneAndUpdate({ _id: userId }, userProfileImage, { new: true });
...
exports.default = userProfileUploadAndDeleteController;
